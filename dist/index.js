...
const Voitures_1 = require("./Voitures");
const Motos_1 = require("./Motos");
const Garage_1 = require("./Garage");
const Camion_1 = require("./Camion");
const voiture1 = new Voitures_1.Voiture("Toyota", "Camry", "AB-123-DE", "Bleu", 50000, 15000, 2018);
const voiture2 = new Voitures_1.Voiture("Honda", "Civic", "XY-789-GR", "Rouge", 40000, 12000, 2019);
const voiture3 = new Voitures_1.Voiture("Ford", "Focus", "DE-457-ZO", "Noir", 60000, 13000, 2017);
const voiture4 = new Voitures_1.Voiture("Volkswagen", "Golf", "GH-789-AS", "Blanc", 35000, 14000, 2020);
const voiture5 = new Voitures_1.Voiture("Chevrolet", "Malibu", "JK-142-ZX", "Rouge", 55000, 11000, 2016);
const moto1 = new Motos_1.Moto("Harley-Davidson", "Noire", "Sportster", "HAR-456-BL", 20000, 8000, 2020);
const moto2 = new Motos_1.Moto("Yamaha", "Bleue", "MT-09", "YAM-789-RD", 15000, 6000, 2019);
const camion1 = new Camion_1.Camion("Peugeot", "blanc", "van", "DW-545-SR", 35000, 15000, 2015);
const monGarage = new Garage_1.Garage("Mon Garage", [voiture1, voiture2, voiture3, voiture4, voiture5, moto1, moto2, camion1]);
const voitureLaMoinsChere = monGarage.trouverVoitureMoinsChere();
if (voitureLaMoinsChere instanceof Voitures_1.Voiture) {
